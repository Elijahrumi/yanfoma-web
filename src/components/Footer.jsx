                    ...
                    <ul className = "list">
                        ...
                        <li className = "list-body">
                            <a href="#" className = "logo">
                                <img src="assets/imgs/logo_yanfoma.png" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, Creative studio Landing page"/>
                            </a>
                            ...
                            <p className = "mt-3">
                                Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a className = "d-inline text-primary" href="https://yanfoma.com">YANFOMA</a>
                            </p>                   
                        </li>
                    </ul>
                    <ul className = "list">
